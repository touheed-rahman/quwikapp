...
const RecentSubcategoryListings = () => {
    ...
    const channel = supabase
      ...
      .on(
        'postgres_changes',
        {
          ...
          schema: 'public',
          table: 'listings',
          filter: `category=eq.${category}${subcategory ? ` AND subcategory=eq.${subcategory}` : ''}`
        },
        () => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-20 pb-24">
        <h1 className="text-2xl font-bold mb-6">
          Recent Listings in {subcategory || category}
        </h1>
...
export default RecentSubcategoryListings;
