...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      check_if_following: {
        Args: { follower_uid: string; following_uid: string }
        Returns: boolean
      }
      ...
      get_listings_by_city: {
        Args: { p_city_id: string; radius_km?: number }
        Returns: {
          id: string
          title: string
          price: number
      ...
      get_listings_by_location: {
        Args: { search_lat: number; search_long: number; radius_km?: number }
        Returns: {
          id: string
          title: string
          price: number
      ...
      request_feature: {
        Args: { listing_id: string; feature_type: string }
        Returns: undefined
      }
      set_limit: {
        Args: { "": number }
