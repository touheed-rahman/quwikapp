    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <Card 
              className={`p-6 ${bgColor} border border-${color.replace('text-', '')}/10 cursor-pointer transition-all duration-300 ${hoverBgColor} hover:shadow-lg relative overflow-hidden group h-full focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2`}
              onClick={onClick}
            >
              {/* Background pattern */}
