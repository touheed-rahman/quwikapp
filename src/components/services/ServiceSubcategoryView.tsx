      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {category.subcategories.map((subcat: any) => {
          ...
          return (
            ...
            >
              <div className="relative h-40 bg-gradient-to-br from-primary/5 to-primary/10 p-4">
              ...
              <CardContent className="p-4 space-y-4">
                <div className="flex justify-between items-center">
                  <div className="text-sm text-muted-foreground flex items-center gap-1">
                    ...
                    <span>
                      {Math.floor(Math.random() * 2) + 1}-{Math.floor(Math.random() * 2) + 2} hrs
                    </span>
                  </div>
                  <div className="text-sm text-muted-foreground flex items-center gap-1">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button onClick={() => handleBookService(subcat.id)}>
                    Book Now
                  </Button>
                </div>
                ...
                {subcat.tags && (
                  <div className="flex flex-wrap gap-1 mt-2">
                    {subcat.tags.map((tag: string, i: number) => (
