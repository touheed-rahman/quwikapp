...
const ServiceView = () => {
  ...
  return (
    ...
    >
      <motion.div 
        className="bg-gradient-to-r from-purple-100 via-primary/5 to-blue-100 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-primary/20 shadow-lg"
        variants={item}
      >
        <motion.div className="text-center mb-6">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary via-primary/80 to-purple-500 text-transparent bg-clip-text inline-block mb-3">
        ...
        <motion.div className="flex flex-col md:flex-row gap-4 items-center">
          <div className="w-full md:w-1/2 relative">
            <LocationSelector 
              ...
              className="h-12 pl-10 w-full rounded-lg border-primary/20 focus:ring-primary focus:border-primary transition-all"
            />
